...
var AppComponent = React.createClass({
  ...
  componentDidMount: function () {
    ...
    this.Constant.hPosRange.rightSecX[1] = stageW - halfImgW * 2;
    this.Constant.hPosRange.y[0] = -halfImgH;
    this.Constant.hPosRange.y[1] = stageH - halfImgH * 1.5;

    // 计算上侧区域图片排布位置的取值范围
    this.Constant.vPosRange.topY[0] = -halfImgH;
    this.Constant.vPosRange.topY[1] = halfImgH;
    this.Constant.vPosRange.x[0] = halfStageW - halfImgW * 2;
